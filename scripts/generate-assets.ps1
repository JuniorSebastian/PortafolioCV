...
$logo.Graphics.DrawString('JO', $logoFont, (New-Brush $ivory), 256, 256, $centerFormat)
...
$screenshot.Graphics.DrawString('Full Stack · Groq · Gemini', $bodyFont, $textBrush, 200, 260)
...
$og.Graphics.DrawString('Junior Osorio', $ogTitleFont, (New-Brush $ivory), 80, 160)
$og.Graphics.DrawString('Generador de Presentaciones con IA', $ogBodyFont, (New-Brush $accent), 80, 260)
$og.Graphics.DrawString('Node.js · React · Groq · Gemini · MySQL · Vercel', $ogBodyFont, (New-Brush $ivory), 80, 320)
$og.Graphics.Dispose()
...
$iconGraphics.DrawString('JO', $iconFont, (New-Brush $ivory), 32, 32, $iconFormat)
