    ...
    <div className="section-wrapper relative flex flex-col gap-14 lg:flex-row lg:items-start">
      ...
      <div className="relative lg:w-1/2">
        ...
        <p className="mt-6 text-base text-slate-200">
          ¿Quieres colaborar o contratarme? Escríbeme a juniorosoriotoribio666@gmail.com o visita mi LinkedIn y GitHub.
        </p>
        <div className="mt-8 grid gap-4 text-sm text-white/80">
          <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-5 py-4 shadow-soft">
            ...
            <div>
              ...
              <a href="mailto:juniorosoriotoribio666@gmail.com" className="text-sm font-semibold text-white hover:text-accent">
          ...
          <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-5 py-4 shadow-soft">
            ...
            <div>
              ...
              <a href="tel:+51982706458" className="text-sm font-semibold text-white hover:text-accent">
                +51 982 706 458
              </a>
            </div>
          </div>
